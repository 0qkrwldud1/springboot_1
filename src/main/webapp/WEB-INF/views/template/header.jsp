...
.close:hover, .close:focus {
	...
	<div id="header">
		<div class="nav_1">
			<a href="${root}/"><span>E</span><span>A</span><span>T</span>          <span>T</span><span>H</span><span>E</span>          <span>J</span><span>E</span><span>J</span><span>U</span></a>
	...
	$("#searchInput").on("change keyup paste", function() {
		...
		Kakao.init('c413e299c996a33dc44f7abdf4ac4223');
